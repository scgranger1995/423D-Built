      ...
      <main className="min-h-screen flex items-center justify-center" style={{ backgroundColor: "#000" }}>
        <div className="text-center px-6">
          ...
          <p style={{ color: "#9ca3af" }} className="mb-6">
            This page hasn&apos;t been configured yet. Create a &quot;contact&quot; page in the admin panel.
          </p>
          <Link
            href="/admin/pages"
...
export async function generateMetadata() {
  ...
  return {
    title: page ? `${page.title} | 423D Built` : "Contact | 423D Built",
    description: page?.description || "Contact 423D Built for custom 3D printing and laser engraving",
  };
}
